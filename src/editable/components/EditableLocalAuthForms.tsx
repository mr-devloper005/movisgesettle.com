...
const inputClass = 'h-12 rounded-md border border-slate-300 bg-white px-4 text-base font-bold text-[#102033] outline-none transition placeholder:text-slate-500 focus:border-[#1f73be] focus:bg-white'
const buttonClass = 'inline-flex h-12 items-center justify-center rounded-md bg-[#1f73be] px-6 text-sm font-black text-white shadow-sm transition hover:-translate-y-0.5 disabled:opacity-60'
